...
if($PSVersiontable.PSVersion.Major -lt 3)
{
    ...
    Write-Output "Download from: https://www.python.org/ftp/python/3.11.0/python-3.11.0-embed-amd64.zip"
...
{
    Invoke-WebRequest -Uri https://www.python.org/ftp/python/3.11.0/python-3.11.0-embed-amd64.zip -OutFile python.zip
...
((Get-Content python\python311._pth)) -Replace "#import", "import" | Set-Content python\python311._pth
Set-Content python\python311._pth -value "../", (Get-Content python\python311._pth)
